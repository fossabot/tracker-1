...
type GraphItem struct {
	...
	Encoding             GraphItemEncoding `protobuf:"varint,4,opt,name=encoding,proto3,enum=cloud.deps.tracker.api.v1alpha.store.GraphItemEncoding" json:"encoding,omitempty"`
...
func init() {
	proto.RegisterEnum("cloud.deps.tracker.api.v1alpha.store.GraphItemEncoding", GraphItemEncoding_name, GraphItemEncoding_value)
	proto.RegisterType((*GraphItem)(nil), "cloud.deps.tracker.api.v1alpha.store.GraphItem")
	proto.RegisterType((*GraphItemPair)(nil), "cloud.deps.tracker.api.v1alpha.store.GraphItemPair")
	proto.RegisterType((*PutRequest)(nil), "cloud.deps.tracker.api.v1alpha.store.PutRequest")
	proto.RegisterType((*PutResponse)(nil), "cloud.deps.tracker.api.v1alpha.store.PutResponse")
	proto.RegisterType((*DeleteRequest)(nil), "cloud.deps.tracker.api.v1alpha.store.DeleteRequest")
	proto.RegisterType((*DeleteResponse)(nil), "cloud.deps.tracker.api.v1alpha.store.DeleteResponse")
	proto.RegisterType((*ListRequest)(nil), "cloud.deps.tracker.api.v1alpha.store.ListRequest")
	proto.RegisterType((*ListResponse)(nil), "cloud.deps.tracker.api.v1alpha.store.ListResponse")
	proto.RegisterType((*FindRequest)(nil), "cloud.deps.tracker.api.v1alpha.store.FindRequest")
	proto.RegisterType((*FindResponse)(nil), "cloud.deps.tracker.api.v1alpha.store.FindResponse")
}
...
var fileDescriptor_98bbca36ef968dfc = []byte{
	...
	,
}
...
func (c *graphStoreClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, "/cloud.deps.tracker.api.v1alpha.store.GraphStore/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *graphStoreClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cloud.deps.tracker.api.v1alpha.store.GraphStore/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *graphStoreClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cloud.deps.tracker.api.v1alpha.store.GraphStore/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *graphStoreClient) FindUpstream(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*FindResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cloud.deps.tracker.api.v1alpha.store.GraphStore/FindUpstream", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *graphStoreClient) FindDownstream(ctx context.Context, in *FindRequest, opts ...grpc.CallOption) (*FindResponse, error) {
	out := new(FindResponse)
	err := c.cc.Invoke(ctx, "/cloud.deps.tracker.api.v1alpha.store.GraphStore/FindDownstream", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GraphStore_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.deps.tracker.api.v1alpha.store.GraphStore/Put",
	}
...
func _GraphStore_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.deps.tracker.api.v1alpha.store.GraphStore/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GraphStore_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.deps.tracker.api.v1alpha.store.GraphStore/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GraphStore_FindUpstream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.deps.tracker.api.v1alpha.store.GraphStore/FindUpstream",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GraphStore_FindDownstream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cloud.deps.tracker.api.v1alpha.store.GraphStore/FindDownstream",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _GraphStore_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.deps.tracker.api.v1alpha.store.GraphStore",
